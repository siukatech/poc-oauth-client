...
@Slf4j
@ConditionalOnProperty(value = "keycloak.jwt.auth.handler", havingValue = "1", matchIfMissing = true)
@Component
public class KeycloakLogoutHandlerImpl implements KeycloakLogoutHandler {
...
//    }
    public KeycloakLogoutHandlerImpl() {
        this.restTemplate = new RestTemplate();
    }
